package com.interview.coding.battleshipservice.controller.provider;

import com.interview.coding.battleshipapi.contract.ErrorResponse;
import com.interview.coding.battleshipservice.exception.BattleshipException;
import com.interview.coding.battleshipservice.exception.GameFinishedException;
import com.interview.coding.battleshipservice.exception.GameJoinException;
import com.interview.coding.battleshipservice.exception.GameNotFoundException;
import com.interview.coding.battleshipservice.exception.GameStartException;
import com.interview.coding.battleshipservice.exception.NotYourTurnException;
import com.interview.coding.battleshipservice.exception.ShipDeploymentException;
import com.interview.coding.battleshipservice.exception.ShipsAlreadyDeployedException;
import com.interview.coding.battleshipservice.exception.WrongCoordinateException;
